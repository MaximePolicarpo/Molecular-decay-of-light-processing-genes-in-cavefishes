...
legend(x=29, y=62,legend=c("76","70","60","50","40","30","20","19"), col=c("gray67", "goldenrod4", "deepskyblue4", "darkorchid1", "darkolivegreen2", "coral", "cadetblue2", "bisque1"), pch=15, cex=1.5)
...
title(main=substitute(paste("Distribution of the number of LoF mutations per gene in ",italic('Lucifuga'), " spp.")), xlab="Number of LoF mutations per gene", cex.lab=1.8, cex.main=2, cex.axis=1.5)
#mtext("Number of genes", side=2, line=2, cex=2)

#title(main=substitute(italic("Lucifuga dentata")), xlab="Number of LoF mutations per gene", cex.lab=1.8, cex.main=2)
...
dev.off()
"Distribution of the number of LoF mutations per gene in Lucifuga spp."
